...
union all
SELECT L5.auctionID, L5.lotNumber, L5.Buyer, acseller.fullName AS Seller, L5.AgentName, L5.AuctioneerName, L5.breed, L5.quantity, L5.lotSellingPrice,L5.sellerauctionId, L5.buyerauctionId, L5.passedIn, adb.auctionDay buyerauctiondate, ads.auctionDay sellerauctiondate, sab.startTime buyerauctiontime, sas.startTime sellerauctiontime FROM 
...
inner join sheepauction as sab on sab.auctionId = L5.buyerauctionId
inner join sheepauction as sas on sas.auctionId = L5.sellerauctionId
WHERE L5.lotSellingPrice is not null
INTO OUTFILE 'C:/DatabaseBackup/sheeps.csv' 
FIELDS ENCLOSED BY '' 
TERMINATED BY ',' 
ESCAPED BY '"' 
LINES TERMINATED BY '\r\n';